...
class SL2Encoder:
    ...
    def _create_block(self, record, index):
        ...
        unknownPart2 = bytes([0x02]*5)
        frequency = int(float(record['frequency']))
        unknownPart3 = bytes([0x03]*2)
        ...
        unknowPart5 = bytes([0x05]*6)
        time_offset = int(float(record['time_offset']))
        unknownPart6 = bytes([0x06]*6)
        ...
        block = struct.pack(
            '<28shhhhiff5sb2sif32sffiiffffh6sh6s',
            ...
            unknownPart3,      # Unbekannter Teil 3 mit 0x03, Länge: 2 Bytes, Offset: 54
            time1,             # Zeit (ms seit Boot), Länge: 4 Bytes (int), Offset: 56
            water_depth,       # Wassertiefe, Länge: 4 Bytes (float), Offset: 60
            unknownPart4,      # Unbekannter Teil 4 mit 0x04, Länge: 32 Bytes, Offset: 64
            speed_gps,         # Geschwindigkeit, Länge: 4 Bytes (float), Offset: 96
            temperature,        # Temperatur, Länge: 4 Bytes (float), Offset: 100
            latitude,          # Breite, Länge: 4 Bytes (float eigentlich int), Offset: 104 TODO: In Spherical Mercator Projection umrechenen und dann in int umwandeln (nicht relevant bei raw data)
            longitude,         # Länge, Länge: 4 Bytes (float eigentlich int), Offset: 108 TODO: In Spherical Mercator Projection umrechenen und dann in int umwandeln (nicht relevant bei raw data)
            speed_water,       # Geschwindigkeit Wasser, Länge: 4 Bytes (float), Offset: 112
            course_over_ground,# Kurs über Grund, Länge: 4 Bytes (float), Offset: 116
            altitude,          # Höhe, Länge: 4 Bytes (float), Offset: 120
            heading,           # Heading, Länge: 4 Bytes (float), Offset: 124
            flags,             # Flags, Länge: 2 Bytes (short), Offset: 128
            unknowPart5,       # Unbekannter Teil 5 mit 0x05, Länge: 6 Bytes, Offset: 130
            time_offset,       # Zeitoffset, Länge: 2 Bytes (short), Offset: 136
            unknownPart6      # Unbekannter Teil 6 mit 0x06, Länge: 6 Bytes, Offset: 138
        )
